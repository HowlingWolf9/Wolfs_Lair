...
ALGORITHM:
Step 01: START
Step 02: Initialize vowel_arr[10]="AEIOUaeiou", len=0, check=0,vowel=0,cons=0,space=0
Step 03: Take str as input
Step 04: Repeat step 05, WHILE (str[len] != ‘$’)
Step 05: 	Increment len by 1
Step 06: Initialize i=0 and repeat steps 07 to 08, FOR i<len
...
Step 13: 				Set check=1
Step 14: 				BREAK the loop and go to step 17
Step 15: 			ENDIF
...
Step 27: Display vowel,cons and space
Step 28: STOP
*/
//CODE:
#include <stdio.h>
...
void main()
{
	char str[50],copy[50],vowel_arr[10]="AEIOUaeiou";
	int len=0,check=0,vowel=0,cons=0,space=0;
	...
	printf("The string contains %d vowels, %d consonants and %d spaces ",vowel,cons,space);
}
/*
OUTPUT:
Enter the string:India got its independence in 1947$
The string contains 11 vowels, 14 consonants and 5 spaces
*/